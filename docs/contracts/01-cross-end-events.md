...
- 传输决策：[文字闭环使用 SSE 事件通道](../decisions/0014-sse-text-event-channel.md)
...
- 媒体直连与云端代理模式。
- 任务、实时语音和工作机事件的机器载荷 Schema（数据结构规范）及最大大小；文字响应事件已由[第一阶段机器契约](04-phase-1-machine-contracts.md)定稿。
- 工作机连接的设备校验和续租机制。
