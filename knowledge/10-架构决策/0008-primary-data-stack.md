---
id: "arcmind-doc-decisions-0008-primary-data-stack"
type: "decision"
status: "current"
summary: "PostgreSQL 18 是云端唯一主事实数据库，使用 SQLAlchemy、psycopg、Alembic 和可选 pgvector。"
scope: ["decisions"]
...
- 架构结果：[数据存储、事务与检索设计](../05-数据模型/01-数据存储事务与检索.md)
- 领域依据：[核心领域模型（草案）](../02-业务模型/01-核心领域模型.md)
