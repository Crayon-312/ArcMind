---
id: "arcmind-doc-decisions-0006-mobile-web-stack"
type: "decision"
status: "current"
summary: "手机 Web 使用 React、TypeScript 和 Vite，结合 React Router、TanStack Query 与 Tailwind CSS。"
scope: ["decisions"]
...
- 架构结果：[手机 Web 端](../06-前端设计/01-手机Web端设计.md)
- 模块落点：[手机 Web 模块](../06-前端设计/03-手机Web模块.md)
