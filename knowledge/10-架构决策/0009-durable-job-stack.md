...
type: "decision"
status: "current"
summary: "首版耐久后台任务使用 PostgreSQL 支撑的 Procrastinate，不引入 Redis 或 RabbitMQ。"
scope: ["decisions"]
...
- 架构结果：[耐久 Job、调度与恢复设计](../23-任务与提醒/01-耐久任务调度与恢复.md)
- 业务边界：[任务生命周期](../23-任务与提醒/02-任务生命周期.md)、[提醒与通知](../23-任务与提醒/03-提醒与通知.md)
- 落实台账：[耐久 Job 与提醒调度](../14-开发方案/0006-durable-jobs-and-scheduling.md)
