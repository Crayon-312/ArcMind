---
id: "arcmind-doc-decisions-0014-sse-text-event-channel"
type: "decision"
status: "current"
summary: "手机文字命令使用 HTTPS，云端更新使用支持快照、单调序号和 Last-Event-ID 恢复的 SSE 通道。"
scope: ["decisions"]
...
- 业务来源：[实时对话与任务形成](../02-业务模型/03-实时对话与任务形成.md)
- 契约结果：[跨端事件契约基线](../04-接口与事件/01-跨端事件契约.md)、[云端公开 API 契约草案](../04-接口与事件/02-云端公开API.md)
- 模块边界：[会话与实时交互](../07-后端设计/02-会话与实时交互模块.md)
