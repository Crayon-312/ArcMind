...
type: "decision"
status: "current"
summary: "跨端契约采用 OpenAPI 3.1 和版本化 JSON Schema，工作机首版使用 Electron 与严格渲染隔离。"
scope: ["decisions"]
...
- 工程组织：[代码仓库与三套可部署应用](../03-系统架构/02-代码仓库与可部署应用.md)
- 安全与执行：[安全与部署边界](../08-安全与合规/01-安全与部署边界.md)、[工作机端](../22-工作机执行端/01-工作机客户端设计.md)
