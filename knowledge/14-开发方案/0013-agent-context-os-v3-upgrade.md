...
- 协作边界：[开发协作引擎与产品运行时分离](../10-架构决策/0003-development-engine-boundary.md)
- 知识库决策：[Obsidian 知识库与任务隔离发布](../10-架构决策/0010-obsidian-task-publication.md)
- 知识关系：[知识关系分层模型](../10-架构决策/0011-knowledge-relationship-model.md)
- 发布决策：[完整使用 Agent Context OS schema 3 与 Obsidian 唯一知识源](../10-架构决策/0016-agent-context-os-v3-obsidian-source.md)
- 验收入口：[V2 文档基线验收](../11-测试与验收/01-documentation-acceptance.md)
