...
- 选型入口：[技术选型与决策门禁](../09-技术调研/01-技术选型与决策门禁.md)
- 发布决策：[云端与产品主 Agent 技术栈](../10-架构决策/0005-cloud-agent-runtime-stack.md)、[手机 Web 技术栈](../10-架构决策/0006-mobile-web-stack.md)、[跨端工程与工作机基线](../10-架构决策/0007-engineering-baseline.md)
...
| 影响类型 | 内容 | 状态 | 写回位置 |
|---|---|---|---|
| 架构 | 确定云端、主 Agent、手机和工作机运行时 | current | [技术选型与决策门禁](../09-技术调研/01-技术选型与决策门禁.md) |
| 仓库 | 单仓库三应用从提议转为正式决策 | current | [决策 0004](../10-架构决策/0004-three-app-monorepo.md) |
| 接口 | 确定 OpenAPI 3.1 与 JSON Schema 契约源 | current | [决策 0007](../10-架构决策/0007-engineering-baseline.md) |
| 数据 | 明确框架运行态不得替代领域事实 | current | [决策 0005](../10-架构决策/0005-cloud-agent-runtime-stack.md) |
| 安全 | 增加 Electron 隔离、IPC 校验和本地页面要求 | current | [决策 0007](../10-架构决策/0007-engineering-baseline.md) |
| 测试 | 确定 pytest、Vitest 和 Playwright 分层 | current | [决策 0006](../10-架构决策/0006-mobile-web-stack.md)、[决策 0007](../10-架构决策/0007-engineering-baseline.md) |
| 发布 | 确定 Docker Compose 单 VPS 基线 | current | [决策 0007](../10-架构决策/0007-engineering-baseline.md) |
